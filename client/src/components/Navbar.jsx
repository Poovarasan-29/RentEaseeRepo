...
export default function Navbar() {
    ...
    return <>
        <nav className="navbar navbar-expand-sm fixed-top" style={{ background: 'rgb(34,34,34)', }} >
            <div className="container-fluid" style={{ background: 'rgb(34,34,34)' }}>
                <Link to={'/renteasee'}  >
                    <img src={"https://firebasestorage.googleapis.com/v0/b/renteasee-29.appspot.com/o/AppImages%2Frenteasee3.png?alt=media&token=a42632b3-fc37-4b53-b484-31a2451f2a09"} className="m-0 ms-5" alt="RentEasee" width="60px" style={{ transform: 'scale(2.2)', filter: 'contrast(3) brightness(2.5)' }} />
                </Link>
