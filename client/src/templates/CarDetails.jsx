               ...
               <div className="col-md-7 col-12">
                  <div className="row row-cols-1 p-2">
                     ...
                     <div id="Img" className="">
                        <img src={carDetails.carPhotos[0]} alt="" />
                     </div>
                     <div className="d-flex  align-items-center justify-content-between mt-2">
                        <div id="S_img" className="p-2">
                           <img src={carDetails.carPhotos[1]} alt="" />
                        </div>
                        <div id="S_img" className="p-2">
                           <img src={carDetails.carPhotos[2]} alt="" />
                        </div>
                        <div id="S_img" className="p-2">
                           <img src={carDetails.carPhotos[3]} alt="" />
                        </div>
                        <div id="S_img" className="p-2">
                           <img src={carDetails.carPhotos[4]} alt="" />
                        </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div className="p-3 border bg-light rounded">
                        ...
                        <table className="" id="More-Details">
                           <tbody>
                              ...
                              <tr>
                                 <td className="p-1">State : {carDetails.city}</td>
                              </tr>
                              <tr>
                                 <td className="p-1">
