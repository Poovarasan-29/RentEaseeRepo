  ...
  return (
    <>
      ...
      >
        <img
          src={
            "https://firebasestorage.googleapis.com/v0/b/renteasee-29.appspot.com/o/AppImages%2FRentEaseeLogo.png?alt=media&token=2d3aa269-d5ac-464d-add4-6d85860db2f8"
          }
          alt="logo"
          className="img-logo"
        />
                    ...
                    <MDBCol col="6" className="position-relative">
                      ...
                      <p
                        ...
                        style={{
                          ...
                          bottom: "4px",
                          left: "15px",
                          visibility: inputsValidation.dob
                            ? "visible"
                            : "hidden",
                        }}
                      >
                  ...
                  <div className="position-relative">
                    ...
                    <p
                      ...
                      style={{
                        ...
                        bottom: "0px",
                        left: "6px",
                        visibility: inputsValidation.address
                          ? "visible"
                          : "hidden",
                      }}
                    >
                      Mininum 50 Characters Required
                    </p>
                    <span
                      className="m-0 text-end d-block pe-1"
                      style={{ fontSize: "13px" }}
                    >
                      Remaining words : {addressCount}
                    </span>
                  </div>
